...
export class CreateWorkOrderNoteDto {
  @ApiProperty({ example: 'Sağ amortisör patlak, yeni parça siparişi verildi.', description: 'Not metni' })
  ...
  @ApiPropertyOptional({ example: true, description: 'Dahili atölye içi not mu?' })
  @IsOptional()
